...
import spark.servlet.VaadinSparkFilter;

public class VaadinDriver {

  @SneakyThrows
  public static void run(int port, String contextPath, SparkApplication... sparkApplications) {
    ...
    if (sparkApplications != null) {
      context.setAttribute(VaadinSparkFilter.SPARK_APP_ID, sparkApplications);
    }
